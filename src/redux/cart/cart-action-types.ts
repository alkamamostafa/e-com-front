...
export const CALCULATE_NEW_CART_PRICE = "cart/CALCULATE_NEW_CART_PRICE";
...
export type CalculateNewCartPriceActionType = {
    type: typeof CALCULATE_NEW_CART_PRICE;
    payload: Array<Perfume>;
};



export type updatePriceCartActionType = {
    type: typeof CALCULATE_NEW_CART_PRICE;
    payload: Array<Perfume>;
};
